export default function ProductShowcase() {
    const showcaseProducts = [
      ...
      { id: 9, label: 'New', imgSrc: '/assets/images/home/chair9.png', title: 'Office Chair', price: '$35', originalPrice: null },
      { id: 10, label: 'Sale', imgSrc: '/assets/images/home/chair10.png', title: 'Gaming Chair', price: '$50', originalPrice: '$60' },
      { id: 11, label: null, imgSrc: '/assets/images/home/chair11.png', title: 'Classic Chair', price: '$28', originalPrice: '$40' },
      { id: 12, label: null, imgSrc: '/assets/images/home/chair12.png', title: 'Dining Chair', price: '$15', originalPrice: null },
    ];
  
    return (
      <div className="py-8 px-4 mt-10 sm:px-8 lg:px-16 w-[85%] mx-auto">
        <h2 className="text-left text-2xl font-bold text-gray-800 mb-6">All Products</h2>
